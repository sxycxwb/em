...
namespace EM.Tests
{
    public abstract class EMTestBase : AbpIntegratedTestBase
    {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<EMApplicationModule>();
            modules.Add<EMDataModule>();
        }

        public void UsingDbContext(Action<EMDbContext> action)
        {
        ...
        public T UsingDbContext<T>(Func<EMDbContext, T> func)
        {
            T result;
